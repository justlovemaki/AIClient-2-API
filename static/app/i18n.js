...
const translations = {
    'zh-CN': {
        ...
        'config.advanced.tokenLogging': 'Token计算日志',
        'config.advanced.enableTokenLogging': '启用Token计算详细日志',
        'config.advanced.tokenLoggingNote': '启用后会在控制台显示详细的Token计算信息（System、Messages、Tools、Total），用于调试和监控',
    ...
    'en-US': {
        ...
        'config.advanced.tokenLogging': 'Token Calculation Logging',
        'config.advanced.enableTokenLogging': 'Enable detailed token calculation logs',
        'config.advanced.tokenLoggingNote': 'When enabled, displays detailed token calculation information (System, Messages, Tools, Total) in the console for debugging and monitoring',
