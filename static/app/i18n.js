...
const translations = {
    'zh-CN': {
        ...
        'config.advanced.autoRecoveryInterval': '自动恢复间隔(分钟)',
        'config.advanced.autoRecoveryThreshold': '不健康比例阈值(%)',
    ...
    'en-US': {
        ...
        'config.advanced.autoRecoveryInterval': 'Auto Recovery Interval (min)',
        'config.advanced.autoRecoveryThreshold': 'Unhealthy Ratio Threshold (%)',
